...
public class FrmManageProduct extends javax.swing.JFrame {
    ...
    private void loadTable(){
        List<ManageProduct> listPaging = productService.findAll();
        model.setNumRows(0);
        if(!listPaging.isEmpty()){
            for(ManageProduct p : listPaging){
    ...
    private void btnAddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAddActionPerformed
        ...
        ManageProduct product = this.validateProduct();
        if(product != null){
            String idInserted = this.productService.insert(product);
    ...
    private void btnUpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnUpdateActionPerformed
        ...
        if(selectedRow != -1){
            ManageProduct product = this.validateProduct();
            if(product != null){
                boolean isUpdated = this.productService.update(product);
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FrmManageProduct().setVisible(true);
            }
        });
    }
